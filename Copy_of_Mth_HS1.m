...
bw(Iout<40)=0;
bwInverse = ~bw;
bwpure=bwareaopen(bwInverse,355);
...
testro=imrotate(lo,-30,'bilinear','crop');
I2=imcrop(testro,[136 133 363 137]);

I_rot = imrotate(I,-30,'bilinear','crop');
...
s= (1:size(I2,2))+double(colshift);
lineFin(z, s, :) = I2;
lf=imrotate(lineFin,30,'bilinear','crop');
